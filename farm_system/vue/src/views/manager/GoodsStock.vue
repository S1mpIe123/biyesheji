  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="进货的数量" prop="num"></el-table-column>
        <el-table-column label="进货的渠道" prop="channel"></el-table-column>
    ...
    <el-dialog title="进货信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        <el-form-item label="农产品名称" prop="goodsId">
          <el-select v-model="data.form.goodsId" placeholder="请选择农产品名称">
            <el-option
        ...
        <el-form-item label="进货数量">
          <el-input-number v-model="data.form.num" :min="1"></el-input-number>
        </el-form-item>
        <el-form-item label="进货渠道">
          <el-input v-model="data.form.channel" placeholder="请输入进货渠道" />
        </el-form-item>
        <el-form-item label="进货日期">
          <el-date-picker 
            v-model="data.form.date" 
            type="datetime" 
            placeholder="选择进货日期时间"
            format="YYYY-MM-DD HH:mm:ss"
            value-format="YYYY-MM-DD HH:mm:ss" />
        </el-form-item>
        <el-form-item label="备注">
          <el-input v-model="data.form.comment" placeholder="请输入备注" />
        </el-form-item>
